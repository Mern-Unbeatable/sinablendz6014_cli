...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Live Luxe" },
      { name: "description", content: "Get in touch with Melbourne's premium short-term rental management team." },
    ],
  }),
  component: Contact,
});
        ...
        <div className="container-luxe grid gap-10 md:grid-cols-[1fr_1.3fr]">
          <aside className="rounded-2xl bg-ink p-8 text-sand-soft">
            ...
            <p className="mt-6 text-sm text-sand-soft/70">
              If you&rsquo;re ready to maximise your property&rsquo;s earning potential with a trusted local team, get in touch today.
            </p>

            <div className="mt-10 space-y-5 text-sm">
              <div className="flex items-start gap-3">
                <span className="flex h-9 w-9 flex-none items-center justify-center rounded-lg bg-copper/15 text-copper"><Mail size={15} /></span>
                <div>
              ...
              <div className="flex items-start gap-3">
                <span className="flex h-9 w-9 flex-none items-center justify-center rounded-lg bg-copper/15 text-copper"><Phone size={15} /></span>
                <div>
              ...
              <div className="flex items-start gap-3">
                <span className="flex h-9 w-9 flex-none items-center justify-center rounded-lg bg-copper/15 text-copper"><MapPin size={15} /></span>
                <div>
