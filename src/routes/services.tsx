...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Management Services — Live Luxe" },
      { name: "description", content: "Support Package, Complete Package, and transparent pricing for Melbourne short-term rental management." },
    ],
  }),
  component: Services,
});
    ...
    <Layout>
        ...
        <div className="container-luxe rounded-3xl bg-sand-soft p-8 shadow-soft md:p-14">
          <div className="grid gap-10 md:grid-cols-[1fr_1.4fr]">
            ...
            <div>
              ...
              <Link to="/contact" className="btn-ghost-dark mt-8">Sign Up</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-luxe rounded-3xl bg-sand-soft p-8 shadow-soft md:p-14">
          <div className="grid gap-10 md:grid-cols-[1.4fr_1fr]">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold">We handle the rest — efficiently, professionally, and positively.</p>
            </div>
            <div className="space-y-4">
      ...
      <section className="section-pad bg-sand">
        <div className="container-luxe text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground">We operate on a simple revenue-share model</p>
      ...
      <section className="relative isolate overflow-hidden bg-ink py-24 text-sand-soft">
        ...
        <div className="container-luxe relative grid gap-10 md:grid-cols-2">
          ...
          <div className="space-y-4">
            {[
              { n: "1", t: "Revenue Assessment", d: "We run a free revenue estimate and assess your property's potential based on location, size, and seasonality." },
              { n: "2", t: "Onboarding, Styling & Furnishing", d: "We onboard your property, coordinate furnishing options based on your budget and goals, and style the space for maximum appeal — right down to the teaspoons." },
              { n: "3", t: "Listing & Launch", d: "We craft your listing, photograph, price dynamically and launch across every major platform." },
            ].map((s) => (
              <div key={s.n} className="rounded-xl border border-white/10 bg-white/[0.04] p-6">
                <div className="flex items-start gap-4">
                  <span className="flex h-8 w-8 flex-none items-center justify-center rounded-full bg-copper text-sm font-semibold text-white">{s.n}</span>
                  <div>
