...
const values = [
  {
    icon: Shield,
    t: "Trust",
    d: "Transparent reporting and clear communication — your property in safe hands.",
  },
  {
    icon: Sparkles,
    t: "Hospitality",
    d: "Hotel-grade standards on every turnover, every check-in, every detail.",
  },
  {
    icon: Heart,
    t: "Care",
    d: "We treat every property like it's our own — because reputations are built that way.",
  },
  {
    icon: Award,
    t: "Performance",
    d: "Smart pricing and channel reach that consistently outperforms self-managed listings.",
  },
];
        ...
        <div className="container-luxe grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-sm text-muted-foreground">
              ...
              way to run short-term rentals — one that delivered hotel-grade hospitality without the
              daily headaches.
            </p>
          ...
          <div className="relative">
            <img
              ...
              alt=""
              loading="lazy"
              className="aspect-[4/5] w-full rounded-xl object-cover shadow-luxe"
            />
            <img
              src={penthouse}
              alt=""
              loading="lazy"
              className="absolute -bottom-8 -left-8 hidden h-48 w-64 rounded-xl object-cover shadow-luxe md:block"
            />
          </div>
        </div>
      </section>
