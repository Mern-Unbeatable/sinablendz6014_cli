                ...
                <Link to={`/properties/${p.slug}`}>
                  ...
                  >
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      />
                      <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-ink/70 px-4 py-1.5 text-sm tracking-[0.1em] text-sand-soft backdrop-blur-sm font-medium">
