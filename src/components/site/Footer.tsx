      ...
      <div className="container-luxe grid gap-12 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li><Link to="/properties" className="hover:text-copper">Properties</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-sand-soft/80">
            <li className="flex items-center gap-2"><Phone size={14} className="text-copper" /> (03) 6123 0127</li>
            <li className="flex items-center gap-2"><Mail size={14} className="text-copper" /> info@liveluxe.com.au</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex gap-3">
            {[Facebook, Instagram, Linkedin].map((Icon, i) => (
              <a key={i} href="#" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 text-sand-soft/80 transition hover:border-copper hover:text-copper">
                <Icon size={15} />
              </a>
            ))}
          </div>
